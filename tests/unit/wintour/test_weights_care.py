...
class TestCareWeight:
    ...
    def test_no_matches(self, garment_factory, pipeline_profile_factory):
        ...
        profile = pipeline_profile_factory(avoid_care=[CARE_TYPES['DRY_CLEAN']])
    ...
    def test_blacklist(self, garment_factory, pipeline_profile_factory):
    ...
    def test_blacklist_multiple(self, garment_factory, pipeline_profile_factory):
        """It accepts multiple values to blacklist."""
        garment = garment_factory(care=CARE_TYPES['DRY_CLEAN'])
        profile = pipeline_profile_factory(avoid_care=[CARE_TYPES['DRY_CLEAN'], CARE_TYPES['HAND_WASH']])
