...
class TestStyleWeight:
    ...
    def test_no_matches(self, garment_factory, style_factory):
        ...
        profile = PipelineProfile(styles=['casual'])
    ...
    def test_match(self, garment_factory, style_factory):
        ...
        profile = PipelineProfile(styles=['casual', 'classy'])
    ...
    def test_debug(self, garment_factory, style_factory):
    ...
    def test_debug_flag(self, garment_factory, style_factory):
