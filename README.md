...
```javascript
{
    "aws_advertising_access_key_id": null,     // The AWS access key ID for the product-advertising user
    "aws_advertising_associate_tag": null,     // The associate tag for the product-advertising API
    "aws_advertising_secret_access_key": null, // The AWS secret access key for the product-advertising user
    "database": {
